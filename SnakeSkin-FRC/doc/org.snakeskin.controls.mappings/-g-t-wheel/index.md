[doc](../../index.md) / [org.snakeskin.controls.mappings](../index.md) / [GTWheel](./index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `GTWheel(id: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`)`<br>Created by cameronearle on 7/28/2017. |
