[doc](../../index.md) / [org.snakeskin.controls.mappings](../index.md) / [Extreme3D](./index.md)

# Extreme3D

`class Extreme3D : `[`Controller`](../../org.snakeskin.controls/-controller/index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `Extreme3D(id: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`)` |
