[doc](../../index.md) / [org.snakeskin.controls.mappings](../index.md) / [DualAction](./index.md)

# DualAction

`class DualAction : `[`Controller`](../../org.snakeskin.controls/-controller/index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `DualAction(id: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`)` |
